AVAILABLE_MODULES = [
    ...
    ("dashboard_budget_vs_actual", "Dashboard: Custo Orcado x Realizado"),
    ...
    ("ops_cash_balances", "Operacoes: Caixa disponivel e aplicacoes"),
    ...
    ("sys_receipt_entries", "Sistema: Entradas recebimentos"),
